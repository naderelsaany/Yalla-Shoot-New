...
- Name: banner.spec.ts >> Sticky Live Score Banner (Tier 2 - Boundaries & Error Cases) >> API failure handles gracefully without breaking banner
- Location: e2e\banner.spec.ts:59:7
