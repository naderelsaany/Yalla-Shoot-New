...
const EXCLUDED_KEYWORDS = [
  ...
  // عسكري/أمني عربي (تسربت في 2026-08-02)
  'الجاهزية العسكرية', 'دول الجوار', 'الأمن السوري', 'خزانات وقود',
  'زوارق مسيرة', 'مطلوبين', 'تصفية جماعية', 'الدفاع العراقية',
  'العمليات العسكرية', 'قوات الأمن', 'اعتقال', 'القبض على',
  // شخصيات غير رياضية
