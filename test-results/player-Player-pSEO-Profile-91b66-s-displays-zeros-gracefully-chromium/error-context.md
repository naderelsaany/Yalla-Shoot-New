...
- Name: player.spec.ts >> Player pSEO Profile (Tier 2 - Boundaries & Error Cases) >> Player with no current season stats displays zeros gracefully
- Location: e2e\player.spec.ts:54:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/players/no-stats
Call log:
  - navigating to "http://localhost:3000/players/no-stats", waiting until "load"
