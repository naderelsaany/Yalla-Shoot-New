...
- Name: player.spec.ts >> Player pSEO Profile (Tier 2 - Boundaries & Error Cases) >> Accessing non-existent player ID returns 404
- Location: e2e\player.spec.ts:49:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/players/999999
Call log:
  - navigating to "http://localhost:3000/players/999999", waiting until "load"
