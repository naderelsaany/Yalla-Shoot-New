...
- Name: cross-feature.spec.ts >> Cross-Feature Combinations (Tier 3) >> Simulated admin updates in database update homepage list and ticker simultaneously
- Location: e2e\cross-feature.spec.ts:35:7
