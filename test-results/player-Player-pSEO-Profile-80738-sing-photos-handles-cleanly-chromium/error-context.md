...
- Name: player.spec.ts >> Player pSEO Profile (Tier 2 - Boundaries & Error Cases) >> Player with very long name or missing photos handles cleanly
- Location: e2e\player.spec.ts:80:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/players/long-name
Call log:
  - navigating to "http://localhost:3000/players/long-name", waiting until "load"
