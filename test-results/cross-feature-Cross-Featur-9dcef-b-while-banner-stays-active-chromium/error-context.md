...
- Name: cross-feature.spec.ts >> Cross-Feature Combinations (Tier 3) >> Clicking World Cup in navigation redirects to World Cup Hub while banner stays active
- Location: e2e\cross-feature.spec.ts:66:7
