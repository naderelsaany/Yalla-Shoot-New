...
- Name: match-list.spec.ts >> Match List & Live Score Ticker (Tier 2 - Boundaries & Error Cases) >> Empty state when no matches exist on selected date in matches page
- Location: e2e\match-list.spec.ts:113:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/matches?date=2026-12-31
Call log:
  - navigating to "http://localhost:3000/matches?date=2026-12-31", waiting until "load"
