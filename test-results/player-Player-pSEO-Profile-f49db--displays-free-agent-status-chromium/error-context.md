...
- Name: player.spec.ts >> Player pSEO Profile (Tier 2 - Boundaries & Error Cases) >> Free agent player displays free agent status
- Location: e2e\player.spec.ts:67:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/players/free-agent
Call log:
  - navigating to "http://localhost:3000/players/free-agent", waiting until "load"
