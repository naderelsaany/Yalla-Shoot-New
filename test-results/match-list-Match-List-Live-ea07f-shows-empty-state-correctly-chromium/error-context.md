...
- Name: match-list.spec.ts >> Match List & Live Score Ticker (Tier 2 - Boundaries & Error Cases) >> Out of bounds page parameter shows empty state correctly
- Location: e2e\match-list.spec.ts:170:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/matches?page=999
Call log:
  - navigating to "http://localhost:3000/matches?page=999", waiting until "load"
