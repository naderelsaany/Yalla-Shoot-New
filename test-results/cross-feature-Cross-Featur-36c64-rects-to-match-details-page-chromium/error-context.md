...
- Name: cross-feature.spec.ts >> Cross-Feature Combinations (Tier 3) >> Clicking a live match in the sticky banner redirects to match details page
- Location: e2e\cross-feature.spec.ts:11:7
