...
- Name: banner.spec.ts >> Sticky Live Score Banner (Tier 2 - Boundaries & Error Cases) >> Banner behaviour when no live matches are active
- Location: e2e\banner.spec.ts:44:7
