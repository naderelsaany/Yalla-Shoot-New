...
- Name: match-list.spec.ts >> Match List & Live Score Ticker (Tier 1) >> Match details page displays teams, score, and status info
- Location: e2e\match-list.spec.ts:77:7
