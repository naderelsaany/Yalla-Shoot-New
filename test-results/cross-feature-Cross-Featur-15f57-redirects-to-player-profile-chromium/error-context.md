...
- Name: cross-feature.spec.ts >> Cross-Feature Combinations (Tier 3) >> Clicking a player in the match lineup redirects to player profile
- Location: e2e\cross-feature.spec.ts:19:7
