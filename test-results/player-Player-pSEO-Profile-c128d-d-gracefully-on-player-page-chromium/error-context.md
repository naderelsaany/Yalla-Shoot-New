...
- Name: player.spec.ts >> Player pSEO Profile (Tier 2 - Boundaries & Error Cases) >> Supabase API crash handled gracefully on player page
- Location: e2e\player.spec.ts:93:7
