...
- Name: match-list.spec.ts >> Match List & Live Score Ticker (Tier 2 - Boundaries & Error Cases) >> API failure handling keeps page stable
- Location: e2e\match-list.spec.ts:127:7
