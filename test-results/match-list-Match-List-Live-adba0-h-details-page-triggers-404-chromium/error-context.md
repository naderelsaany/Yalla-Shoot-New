...
- Name: match-list.spec.ts >> Match List & Live Score Ticker (Tier 2 - Boundaries & Error Cases) >> Navigation to non-existent match details page triggers 404
- Location: e2e\match-list.spec.ts:141:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/match/999999
Call log:
  - navigating to "http://localhost:3000/match/999999", waiting until "load"
